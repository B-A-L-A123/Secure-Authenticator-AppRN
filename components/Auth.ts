...
import { getAuthErrorMessage, validateEmail, validatePassword } from '../utils/validators';
import type { User, AuthError } from '../utils/types';

// Re-export for backward compatibility
export { validateEmail, validatePassword, getAuthErrorMessage };
